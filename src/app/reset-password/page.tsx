...
const ResetPasswordPage = () => {
  ...
  const token = searchParams.get('token') || '' // ✅ Ensure token always has a value
    ...
    try {
      const response = await fetch('/api/users/reset-password', {
        ...
        body: JSON.stringify({
          ...
          newPassword: password,      // ✅ Must match API field
        }),
      })
      ...
      if (response.ok) {
        ...
        setTimeout(() => {
          router.push('/page') // Replace with your login page path
        }, 2500)
      } else {
